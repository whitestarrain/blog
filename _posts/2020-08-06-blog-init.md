...
从texture极简主题开始修改<br>
添加分页，管理员插件<br>
toc,tag则通过纯liquid代码实现<br>

# 1. 教程推荐

- 视频教程：[youtube网址](https://www.youtube.com/watch?v=Zt_QzSbyDcw&list=PLK2w-tGRdrj7vzX7Y-GqKPb2QPrHCYZY1)
    > 包含环境搭建，部署以及主题，插件的使用，作为入门够了

- 关于环境：ruby,gem,bundle的大致关系（以java为例）：
    - ruby--java
    - gem--jar
    - bundle--maven
- Jekyll常用配置文档：
...
![ahAloq.jpg](https://s1.ax1x.com/2020/08/07/ahAloq.jpg)
<!-- ![](../imageMapping/images/2020-08-06-blog-init-01.jpg) -->
