...
3. 选择工作空间以及对应解析器
![](../_images/anaconda-init-5.jpg)

此时，`ctrl+shift+` 新建终端，会发现自动进入虚拟环境。
程序执行时也会在指定虚拟环境中执行。
![](../_images/anaconda-init-6.jpg)
